...
public class BuildingService implements IBuildingService {
	...
	public List<BuildingDTO> findAll(BuildingSearchBuilder fieldSearch, Pageable pageable) {
		...
		if (roles.contains("ROLE_STAFF")) {
			buildingEntities = buildingRepository.findAllByStaff(properties, pageable, fieldSearch);
		} else {
			buildingEntities = buildingRepository.findAll(properties, pageable, fieldSearch);
		}
	...
	public BuildingDTO findById(Long buildingid) {
		...
		return buildingConverter.convertToDTO(buildingRepository.findById(buildingid).get());
	}
	...
	public void update(BuildingDTO buildingDTO) {
		...
		rentAreaRepository.findByBuilding(buildingEntity).stream().forEach(item -> rentAreaRepository.delete(item));
