...
public class BuildingRepositoryImpl implements BuildingRepositoryCustom {
	...
	@Override
	public List<BuildingEntity> findAllByStaff(Map<String, Object> properties, Pageable pageable,
			BuildingSearchBuilder fieldSearch) {
		
		StringBuilder sql = new StringBuilder("SELECT DISTINCT * FROM building A");

		sql.append(" INNER JOIN assignmentstaff on A.id = assignmentstaff.buildingid");
		sql.append(" INNER JOIN user on assignmentstaff.staffid = user.id");
		...
		sql.append(" AND user.username = '"+user.getUsername()+"'");
